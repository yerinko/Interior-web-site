...
<body>
	...
	<div class="container">
		...
		<div class="container">
		<div>
		<form name="writeData" action="/ots/blog/writeData" method="post" enctype="multipart/form-data">
				...
				<label>TITLE</label>
				<input class="form-control" name="title" id="title" placeholder="제목을 입력해 주세요" required style="width:200px;" /> 
			...
			<textarea class="form-control" colspan="100" name="contents" id="contents" style="width:700px; height:700px;" placeholder="내용을 입력하세요"></textarea>
		</div>
