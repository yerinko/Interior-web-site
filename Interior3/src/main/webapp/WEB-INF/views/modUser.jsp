	...
	<div class="container">
		...
		<div>
			<img src="/ots/resources/image/lock.png" class="img-check"> <img
				src="/ots/resources/image/moduser.png">
		</div>
		</header>
		</br>
		...
		<div>
			<form id="goMod" action="/ots/user/goMod" method="post" enctype="multipart/form-data">
				...
				<label>ID</label>
				<input class="form-control" type="text" id="userid" name="userid" style="width:200px;"required  value="${sessionScope.loginUserid}" readonly /> <span id="joinIDCheck" class=""></span> </br> 
				<label><strong>PASSWORD</strong></label>
				<input class="form-control" id="userpw" name="userpw"
					type="password" style="width:200px;" required> </br> 
					 <label><strong>INTERIOR
						STYLE</strong></label> <select class="form-control" name="style" id="style"
				...
				<button id="modify-btn" type="submit" class="btn btn-default btn-lg btn-block" style="width:200px;" >Modify</button>
