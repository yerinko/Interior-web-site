...
<body>
	...
	<section>
		<div class="container">
			...
			<div id="js-load">
				<c:forEach items="${OtherColorList}" var="OtherColorList">
					<div class="lists__item js-load"
						style="width: 33%; float: left; text-align: center;">
						<a href="${OtherColorList.interior_url}"> <img height="350"
							width="350"
							src="/ots/matching/showing_interior?FileName=${OtherColorList.interior_img}" class="img-rounded">
						</a>
