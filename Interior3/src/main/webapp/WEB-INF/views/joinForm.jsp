				...
				$.ajax({
					...
					success : function(result) {
						if (result.checkCount == 0) {
							$('#joinIDCheck').text("사용할 수 있는 아이디 입니다.");
							$('#joinIDCheck').css('color', 'blue');
						} else {
							$('#joinIDCheck').text("사용중인 아이디 입니다.");
...
<body>
	...
	<div class="container">
		...
		<div>
			<img src="/ots/resources/image/check.png" class="img-check"> <img
				src="/ots/resources/image/joinus.png">
		</div>
		</header>
		</br>
		...
		<div>
			<form id="doJoin" action="/ots/user/doJoin" method="post"
				enctype="multipart/form-data">
				<label><strong>PROFILE upload</strong></label>
				...
				<label>ID</label>
				<input class="form-control" type="text" id="userid" name="userid" style="width:200px;"required /> <span id="joinIDCheck" class=""></span> </br> <label><strong>PASSWORD</strong></label>
				<input class="form-control" id="userpw" name="userpw"
					type="password" style="width:200px;" required> </br> <label><strong>NAME</strong></label>
				<input class="form-control" id="username" name="username"
					type="text" style="width:200px;" required> </br> <label><strong>BIRTHDAY</strong></label>
				<input type="text" name="birth_date" id="birth_date" maxlength="8"
					class="form-control" style="width:200px;" placeholder="ex) 19950620 " required>

				</br> 
				<label><strong>SEX</strong></label> </br> 
				<input type="checkbox"name="sex" value="남자">남자 
				<input type="checkbox"name="sex" value="여자">여자 
				</br> </br> 
					
				<label><strong>INTERIORSTYLE</strong></label> 
				<select class="form-control" name="style" id="style"required style="width:200px;">
				...
				<input type="submit" id="joinBtn" class="btn btn-default btn-lg btn-block" style="width:200px;" value="Join" />
